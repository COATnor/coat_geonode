...
class MothRecords(models.Model):
    ...
    waypoint_name = models.CharField(max_length=20)
    station = models.PositiveSmallIntegerField()
    ep = models.PositiveIntegerField(null= True)
    opl = models.PositiveIntegerField(null= True)
    opint = models.PositiveIntegerField(null= True)
    opdark = models.PositiveIntegerField(null= True)
    opsum = models.PositiveIntegerField(null= True)
    agr = models.PositiveIntegerField(null= True)
    obs = models.CharField(max_length=20, null= True)
    branches = models.PositiveSmallIntegerField(null= True)
